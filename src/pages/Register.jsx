...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("Thanks for joining Calorific!");
      setTimeout(() => {
        setSuccessMessage("");
        ...
        <div className="register-card">
          ...
          <form onSubmit={handleSubmit}>
            <div className="register-input">
              <label>Name</label>
              <input type="text" name="name" value={formData.name} onChange={handleInputChange} required placeholder="Preferred Name" />
              ...
              <div className="register-input-2">
                <div className="register-age">
                  ...
                  <input className="register-number" type="number" name="age" min={10} value={formData.age} onChange={handleInputChange} required placeholder="10" />
                </div>
                <div className="register-age">
                  <label>Height <span>(cm)</span></label>
                  <input className="register-number" type="number" name="height" min={100} value={formData.height} onChange={handleInputChange} required placeholder="100" />
                </div>
                <div className="register-age">
                  <label>Weight <span>(kg)</span></label>
                  <input className="register-number" type="number" name="weight" min={20} value={formData.weight} onChange={handleInputChange} required placeholder="20" />
                </div>
              </div>

              <div>
                <button className="form-submit" type="submit">Sign Up</button>
                <p className="form-existing-user">
